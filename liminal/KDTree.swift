...
public struct BufferedKDTree<Delegate>: Disposable
where
    Delegate: KDTreeDelegate
{
    public typealias Vector = SIMD3<Float>
    public typealias Box = KDBox
    public typealias TreeNode = KDTreeNode<Delegate>
    ...
    @inlinable
    static internal var clusterDistanceSquared: Float {
